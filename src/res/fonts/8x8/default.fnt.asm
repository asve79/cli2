...
dFont		db	"Modified version for CLI by breeze/fishbone",#00 ; * байт описание шрифта, оканчивающихся кодом #00
deFont

bFont		incbin  "rc/fonts/8x8/default.bin"		; Начало данных шрифта
eFont
...
; 	DISPLAY "bFont-taFont",/A,bFont-taFont
	...
	SAVEBIN "../../../../install/system/res/fonts/8x8/default.fnt", sFont, eFont-sFont
